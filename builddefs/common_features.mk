...
VALID_LED_MATRIX_TYPES := is31fl3218 is31fl3236 is31fl3729 is31fl3731 is31fl3733 is31fl3736 is31fl3737 is31fl3741 is31fl3742a is31fl3743a is31fl3745 is31fl3746a my937x snled27351 custom
...
ifeq ($(strip $(LED_MATRIX_ENABLE)), yes)
    ...
    ifeq ($(strip $(LED_MATRIX_DRIVER)), my937x)
...
VALID_RGB_MATRIX_TYPES := aw20216s is31fl3218 is31fl3236 is31fl3729 is31fl3731 is31fl3733 is31fl3736 is31fl3737 is31fl3741 is31fl3742a is31fl3743a is31fl3745 is31fl3746a my937x snled27351 ws2812 custom
ifeq ($(strip $(RGB_MATRIX_ENABLE)), yes)
    ...
    ifeq ($(strip $(RGB_MATRIX_DRIVER)), my937x)
        COMMON_VPATH += $(DRIVER_PATH)/led
        SRC += my937x.c
    endif
