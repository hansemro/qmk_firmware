...
#define OUT_BITS(PORT) (PBIT(PORT, C4) | PBIT(PORT, B6) | PBIT(PORT, D0) | PBIT(PORT, B11) | PBIT(PORT, A11) | PBIT(PORT, A0) | PBIT(PORT, A1) | PBIT(PORT, A2) | PBIT(PORT, A3) | PBIT(PORT, A4) | PBIT(PORT, C10) | PBIT(PORT, C12) | PBIT(PORT, C3) | PBIT(PORT, A10) | PBIT(PORT, B1) | 0)
...
// Alternate Functions
#define AF_BITS(PORT, N) (PAFIO(PORT, N, C9, AFIO_GPIO) | PAFIO(PORT, N, A5, AFIO_GPIO) | PAFIO(PORT, N, A6, AFIO_GPIO) | PAFIO(PORT, N, A7, AFIO_GPIO) | PAFIO(PORT, N, C11, AFIO_GPIO) | PAFIO(PORT, N, C13, AFIO_GPIO) | PAFIO(PORT, N, C14, AFIO_GPIO) | PAFIO(PORT, N, C15, AFIO_GPIO) | PAFIO(PORT, N, C4, AFIO_GPIO) | PAFIO(PORT, N, B6, AFIO_GPIO) | PAFIO(PORT, N, D0, AFIO_GPIO) | PAFIO(PORT, N, B11, AFIO_GPIO) | PAFIO(PORT, N, A11, AFIO_GPIO) | PAFIO(PORT, N, A0, AFIO_GPIO) | PAFIO(PORT, N, A1, AFIO_GPIO) | PAFIO(PORT, N, A2, AFIO_GPIO) | PAFIO(PORT, N, A3, AFIO_GPIO) | PAFIO(PORT, N, A4, AFIO_GPIO) | PAFIO(PORT, N, C10, AFIO_GPIO) | PAFIO(PORT, N, C12, AFIO_GPIO) | PAFIO(PORT, N, C3, AFIO_GPIO) | PAFIO(PORT, N, A10, AFIO_GPIO) | PAFIO(PORT, N, B1, AFIO_GPIO) | 0)
...
const uint8_t bootloader_magic[] __attribute__((section(".magic.bootloader"))) = {
    0x00, 0x40, 0x04, 0x03,                         // builtin bootloader CRC will fail if this word is not correct
