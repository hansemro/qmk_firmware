...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |-----------------------------------------------------------|   ,-------------.
  * |Ctrl|Gui |Alt |      Space            |Alt |Gui |FN1  |Ctrl|   |Lft| Dn |Rgt |
  * `-----------------------------------------------------------'   `-------------'
  */
  ...
  */
  [FN1] = LAYOUT_tkl_ansi( /* FN1 */
      QK_BOOT,  RGB_HUI,  RGB_SAI,  RGB_VAI,  RGB_MOD,  _______,  _______,  _______,  _______,  GUI_TOG,  _______,  _______,  _______,            _______,  _______,  _______,
