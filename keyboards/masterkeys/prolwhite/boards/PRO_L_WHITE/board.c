...
#define OUT_BITS(PORT) (PBIT(PORT, D1) | PBIT(PORT, C1) | PBIT(PORT, D0) | PBIT(PORT, B8) | PBIT(PORT, A11) | PBIT(PORT, A0) | PBIT(PORT, A1) | PBIT(PORT, A2) | PBIT(PORT, A8) | PBIT(PORT, A4) | PBIT(PORT, C5) | PBIT(PORT, C9) | PBIT(PORT, C13) | PBIT(PORT, A10) | PBIT(PORT, B1) | PBIT(PORT, A3) | 0)

#define IN_BITS(PORT) (PBIT(PORT, C4) | PBIT(PORT, A5) | PBIT(PORT, A6) | PBIT(PORT, A7) | PBIT(PORT, C8) | PBIT(PORT, B10) | PBIT(PORT, B11) | PBIT(PORT, B12) | 0)

// Alternate Functions
#define AF_BITS(PORT, N) (PAFIO(PORT, N, C4, AFIO_GPIO) | PAFIO(PORT, N, A5, AFIO_GPIO) | PAFIO(PORT, N, A6, AFIO_GPIO) | PAFIO(PORT, N, A7, AFIO_GPIO) | PAFIO(PORT, N, C8, AFIO_GPIO) | PAFIO(PORT, N, B10, AFIO_GPIO) | PAFIO(PORT, N, B11, AFIO_GPIO) | PAFIO(PORT, N, B12, AFIO_GPIO) | PAFIO(PORT, N, D1, AFIO_GPIO) | PAFIO(PORT, N, C1, AFIO_GPIO) | PAFIO(PORT, N, D0, AFIO_GPIO) | PAFIO(PORT, N, B8, AFIO_GPIO) | PAFIO(PORT, N, A11, AFIO_GPIO) | PAFIO(PORT, N, A0, AFIO_GPIO) | PAFIO(PORT, N, A1, AFIO_GPIO) | PAFIO(PORT, N, A2, AFIO_GPIO) | PAFIO(PORT, N, A8, AFIO_GPIO) | PAFIO(PORT, N, A4, AFIO_GPIO) | PAFIO(PORT, N, C5, AFIO_GPIO) | PAFIO(PORT, N, C9, AFIO_GPIO) | PAFIO(PORT, N, C13, AFIO_GPIO) | PAFIO(PORT, N, A10, AFIO_GPIO) | PAFIO(PORT, N, B1, AFIO_GPIO) | PAFIO(PORT, N, A3, AFIO_GPIO) | 0)
