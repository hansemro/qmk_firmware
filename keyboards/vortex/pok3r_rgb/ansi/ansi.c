...
const uint8_t g_mbi_led_matrix_co[MBI_NUM_CHANNELS][MBI_NUM_LED_GPIO_PINS] = {
    ...
    /*Row2*/ {  28,  30,  31,  32,  33,  34,  35,  36   },
    /*Row3*/ {  42,  43,  44,  45,  46,  47,  48,  49   },
    /*Row4*/ {  54,  55,  56,  8,   9,   10,  11,  13   },
    /*Row5*/ {  NLD, 29,  12,  22,  23,  24,  25,  27   },
    /*Row6*/ {  NLD, NLD, 26,  37,  38,  39,  40,  41   },
    /*Row7*/ {  NLD, 57,  58,  50,  51,  52,  53,  NLD  },
    /*Row8*/ {  NLD, NLD, 59,  60,  61,  62,  NLD, 63   },
