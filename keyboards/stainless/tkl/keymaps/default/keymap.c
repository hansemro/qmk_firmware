...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Function layer - Media controls and extras */
    [1] = LAYOUT_tkl_iso(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,              KC_MSTP, KC_MPRV, KC_VOLD,
