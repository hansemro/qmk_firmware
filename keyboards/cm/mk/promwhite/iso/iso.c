...
const uint8_t g_mbi_led_matrix_co[MATRIX_ROWS][MBI_NUM_CHANNELS] = {
    ...
    /*Row5*/ {  81,  83,  84,  NLD, NLD, NLD, 85,  NLD, NLD, 86,  87,   88,   89,   27,   NLD,  NLD },
...
bool led_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    ...
    led_matrix_set_value(93, host_keyboard_led_state().num_lock ? 0xff : 0x0);
    led_matrix_set_value(94, host_keyboard_led_state().caps_lock ? 0xff : 0x0);
    led_matrix_set_value(95, host_keyboard_led_state().scroll_lock ? 0xff : 0x0);
