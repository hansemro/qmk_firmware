...
* Holtek HT32F52352 (Cortex-M0+)
    ...
    * 16 kB SRAM
    * LQFP64
    * USB/UART ISP bootrom accessed by bridging BOOT pin to ground on reset
...
* **Configure BOOT pin and reset**: Bridge `SEL2` header pins together (with a tweezer) and plug in the keyboard
