...
bool rgb_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    ...
    rgb_matrix_set_color(92, 0x0, 0x0, host_keyboard_led_state().num_lock ? 0xff : 0x0);
    rgb_matrix_set_color(93, 0x0, 0x0, host_keyboard_led_state().caps_lock ? 0xff : 0x0);
    rgb_matrix_set_color(94, 0x0, 0x0, host_keyboard_led_state().scroll_lock ? 0xff : 0x0);
