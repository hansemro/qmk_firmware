...
const uint8_t g_mbi_led_matrix_co[MATRIX_ROWS][MBI_NUM_CHANNELS] = {
    ...
    /* Row1 */ { 17,  19,  21,  23,  25,  27,  29,  31,  NLD, NLD,  NLD, NLD,  1,    5,    8,    NLD },
    /* Row2 */ { 33,  35,  37,  39,  41,  43,  45,  47,  49,  NLD,  NLD, 77,   2,    6,    9,    NLD },
    /* Row3 */ { 34,  36,  38,  40,  42,  44,  46,  48,  10,  NLD,  NLD, 76,   3,    15,   NLD,  NLD },
    /* Row4 */ { 50,  52,  54,  56,  58,  60,  62,  82,  11,  NLD,  NLD, 78,   NLD,  NLD,  NLD,  NLD },
    /* Row5 */ { 51,  53,  55,  57,  59,  61,  NLD, 75,  12,  NLD,  NLD, 79,   NLD,  NLD,  NLD,  NLD },
    /* Row6 */ { 63,  65,  67,  69,  71,  73,  83,  NLD, 86,  NLD,  NLD, 80,   13,   NLD,  NLD,  NLD },
    /* Row7 */ { 64,  66,  68,  70,  72,  74,  85,  84,  NLD, NLD,  NLD, 81,   14,   NLD,  NLD,  NLD },
};
// clang-format on
...
bool rgb_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    if (!host_keyboard_led_state().caps_lock) {
        rgb_matrix_set_color(50, 0x0, 0x0, 0x0);
    }
